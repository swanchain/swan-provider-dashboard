    ...
    <div class="providers-network font-14">
      <div class="module-container">
        ...
        <el-table ref="singleTableRef" :data="providersData" @sort-change="handleSortChange" @filter-change="handleFilterChange" style="width: 100%" empty-text="No Data" v-loading="providersTableLoad">
          ...
          <el-table-column prop="uptime" label="Uptime" min-width="100" >
            <template #default="scope">
...
import { copyContent, debounce, fixedformat, hiddAddress, paginationWidth, replaceFormat, unifyNumber } from "@/utils/common";
