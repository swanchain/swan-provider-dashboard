      ...
      <div class="module-container">
        ...
        <el-table ref="singleTableRef" :data="providerBody" style="width: 100%" empty-text="No Data" v-loading="providersECPLoad" @sort-change="handleSortChange" @filter-change="handleFilterChange">
          ...
          <el-table-column prop="status" column-key="status" filterable :filters="[
              ...
              { text: 'Sibly', value: 'Sibly' }]" filter-placement="bottom-end" :filter-multiple="false" min-width="90">
            <template #header>
          ...
          <el-table-column prop="uptime" min-width="90">
            <template #header>
...
function handleSortChange({ prop, order }) {
  ...
  networkZK.order = prop
  networkZK.desc = order === 'descending' ? true : false
  getUBITable()
}
